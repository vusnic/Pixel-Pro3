...
return [
    ...
    | versiones, como las reglas de tamaño. Siéntase libre de modificar cada uno de estos mensajes.
    |
    */
    ...
    | ayuda a especificar rápidamente una línea de lenguaje personalizada específica para
    | una regla de atributo determinada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se utilizan para cambiar nuestro marcador de posición
    | de atributo por algo más fácil de leer, como "Dirección de correo electrónico"
