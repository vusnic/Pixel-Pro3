...
@section('title', 'Edit Project - Pxp3 Admin')
...
<div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select bg-white @error('category') is-invalid @enderror" 
                                                ...
                                                <option value="ui-ux" {{ old('category', $portfolio->category) == 'ui-ux' ? 'selected' : '' }}>UI/UX Design</option>
                                                ...
                                                <option value="cms" {{ old('category', $portfolio->category) == 'cms' ? 'selected' : '' }}>CMS</option>
                                            </select>
                                            @error('category')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-9">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control bg-white @error('image') is-invalid @enderror" 
                                                   id="image" name="image">
                                            <div class="form-text">Leave empty to keep the current image. Recommended size: 1200x800 pixels. Max file size: 2MB.</div>
                                            @error('image')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                            ...
                            <div class="p-4 rounded-4 bg-light bg-opacity-10">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control bg-white @error('description') is-invalid @enderror" 
                                              id="description" name="description" rows="6" required>{{ old('description', $portfolio->description) }}</textarea>
                        ...
                        <div class="col-12">
                            <div class="p-4 rounded-4 bg-light bg-opacity-10">
                                ...
                                <div class="highlights-container mb-3">
                                    @php
                                        $highlights = old('highlights', $portfolio->highlights ? json_decode($portfolio->highlights, true) : []);
                                    @endphp
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check mt-4">
                                            <input class="form-check-input bg-white" type="checkbox" id="featured" 
                                                   name="featured" value="1" {{ old('featured', $portfolio->featured) ? 'checked' : '' }}>
    ...
    <div class="col-md-4">
        ...
        <div class="card rounded-5 border-0 shadow-lg mb-4">
            ...
            <div class="card-body p-4">
                <div class="mb-3">
                    <h6 class="fw-bold">Updating Portfolio Items</h6>
                    <ul class="text-muted mb-0">
                        <li>Review changes carefully</li>
                        <li>Update images if needed</li>
                        <li>Keep highlights relevant</li>
                        <li>Check project status</li>
                        <li>Verify all links</li>
                    </ul>
                </div>
                <div class="alert alert-info">
                    <i class="fas fa-lightbulb me-2"></i>
                    <strong>Pro Tip:</strong> When updating a featured project, consider if it still deserves the featured status based on your current portfolio.
                </div>
            </div>
        </div>
    </div>
