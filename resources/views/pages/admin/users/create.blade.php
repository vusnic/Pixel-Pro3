...
@section('title', 'Create User - Pxp3 Admin')
...
<div class="row">
        ...
        <div class="card rounded-5 border-0 shadow-lg mb-4">
            <div class="card-header bg-tertiary bg-opacity-10 border-0">
                <h5 class="card-title mb-0 fw-bold">
                    <i class="fas fa-user-plus me-2 text-tertiary"></i>
                    User Information
                </h5>
            </div>
    ...
    <div class="col-md-4">
        ...
        <div class="card rounded-5 border-0 shadow-lg mb-4">
            ...
            <div class="card-body p-4">
                <div class="mb-3">
                    <h6 class="fw-bold">Creating Effective Users</h6>
                    <ul class="text-muted mb-0">
                        <li>Use clear, professional names</li>
                        <li>Assign appropriate roles based on responsibilities</li>
                        <li>Use strong, unique passwords</li>
                        <li>Verify email addresses</li>
                        <li>Consider implementing 2FA for admin users</li>
                    </ul>
                </div>
                <div class="alert alert-info">
                    <i class="fas fa-lightbulb me-2"></i>
                    <strong>Pro Tip:</strong> Administrators have full access to all system features. Use this role carefully.
                </div>
            </div>
        </div>
    </div>
